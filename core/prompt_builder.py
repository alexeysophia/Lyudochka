...
## Правила команды (написаны в разметке Jira wiki markup):
{rules}
...
5. Если тип задачи — Epic, добавь поле "epic_name": краткое название Эпика максимум из 3 слов на русском, отражающее суть. Для задач другого типа поле "epic_name" не включай.
...
{{
  ...
  "epic_name": "Три слова (только если Epic)",
  "jira_params": {{
