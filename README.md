...
- **Управление командами** — для каждой команды задаются правила написания задач и шаблон Definition of Done
...
| Definition of Done | Шаблон критериев завершения, который ИИ включит в задачу |
...
data/
  models.py                    # датаклассы: Team, Settings, AIResponse
